...
$pdf->Write(0, 'Products Viewed Report', '', 0, 'C', true, 0, false, false, 0);
...
$tbl_footer = '</table>';
$tbl ='<tr><td align="center">Product Name</td><td  align="center">Viewed</td></tr>';;
mysql_connect("localhost","sanjaysaxena","sanj@y!@#");
mysql_select_db("villagebazaar");

$query= "SELECT pd.name as name, p.model, p.viewed as viewed FROM oc_product p LEFT JOIN oc_product_description pd ON (p.product_id = pd.product_id) WHERE  p.viewed > 0 ORDER BY p.viewed DESC";
