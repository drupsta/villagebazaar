...
<select onload="location='Kolkata'" onchange="location=this.value;">
 ...
 <!-- <div class="product-compare"><a href="<?php echo $compare; ?>" id="compare-total"><?php echo $text_compare; ?></a></div>-->
  ...
  // $count=$count+1;
	...
	$distance = $distance * 60 * 1.1515 * 1.609344 ;
      ...
      //  $test1[$count]= $distance;
        echo "<br>Distance from ". $address ." is ".$distance." km" ;
     //   echo "<BR>".$count."   ".$test1[$count];
            
     //   sort($test1);
     //   print_r($test1);
         
  //   $_SESSION['testaddress']=$product['selleraddress'];
   //       echo $_SESSION['testaddress']."ghghggghh";
         ?>
      </div> <?php } ?>
           <?php if ($product['selleraddress']) { ;?>
      <div class="cart"><input type="button" value="<?php echo $entry_map; ?>" onclick="return popup('catalog/view/theme/default/template/product/GoogleMap.php?testaddress=<?php echo $address1;?>');" class="button" /> 
        </div><?php   } ?>
      ...
      <?php } ?>
 <!--    <div class="cart"><input type="button" value="<?php echo ''; ?>" onclick="return popup('catalog/view/theme/default/template/product/GoogleMap.php?testaddress=<?php echo $address1;?>');" class="button" />-->
...
function popup(url) {
new_popup = window.open(url, "Popup Window", "width=500,height=400,resizable=yes");
new_popup.focus();
return false;
}</script>
<script type="text/javascript"><!--
