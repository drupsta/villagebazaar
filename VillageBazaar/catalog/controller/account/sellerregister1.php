...
class ControllerAccountSellerRegister extends Controller {
	...
	if ((utf8_strlen($this->request->post['telephone']) < 10) || (utf8_strlen($this->request->post['telephone']) > 10)
		...
		{
			if ((utf8_strlen($this->request->post['std']) < 2)||!preg_match('/^[0-9]*$/', $this->request->post['std']))
		 	{
		...
		if($this->request->post['postcode']!=NULL) {
			if ((utf8_strlen($this->request->post['postcode']) < 6) || (utf8_strlen($this->request->post['postcode']) > 6) ||!preg_match('/^[0-9]*$/', $this->request->post['postcode'])) {
 ...
 public function country() {
	...
	public function getDungkhag() {
		...
		foreach ($results as $result) {
			...
			//if ($this->request->get['dungkhag_id'] == $result['dungkhag_id']) {
