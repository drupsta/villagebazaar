	...
	public function index() {
		...
		if ($this->request->server['REQUEST_METHOD'] != 'POST') {
			$customer_info = $this->model_account_customer->getCustomer($this->customer->getId());
                    //  $user_info = $this->model_account_customer->getUser($customer_info['username']);
		}
            //    $user_info = $this->model_account_customer->getUser($customer_info['email']);
//print_r($customer_info);
// $_SESSION['test']=$user_info['user_id'];
...
//		}
		...
		if (isset($this->request->post['telephone'])) {
			...
			$this->data['std'] = $customer_info['std'];
		} else {
			$this->data['std'] = '';
		}
			...
			$this->data['country_code'] = $customer_info['country_code'];
		} else {
