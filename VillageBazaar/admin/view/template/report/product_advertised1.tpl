...
<td style="text-align: right;"><a href="view/template/report/pdfCreation.php" class="button"><?php echo $button_download; ?></a></td> 
...
function filter() {
	url = 'index.php?route=report/product_advertised&token=<?php echo $token; ?>';
