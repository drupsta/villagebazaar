 ...
 <?php if ($error_warning) { ?>
  ...
  <div class="box">
	...
	<form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
      <table class="form">
          <tr class="filter">             
              <td><?php echo $text_select_dzongkhag; ?>
                ...
                <option value="*">--None--</option>
              	...
              	<a onclick="filter();" align="left" class="button"><?php echo "Search Dungkhags"; ?></a>
             </td>            
          </tr>           
       </table>
       <table class="list">
          ...
          <tbody>     			  
            ...
            <tr>
				<td style="text-align: center;"><?php if ($dungkhag['selected']) { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $dungkhag['dungkhag_id']; ?>" checked="checked" />
                <?php } else { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $dungkhag['dungkhag_id']; ?>" />
                <?php } ?></td>
              <td class="left"><?php echo $dungkhag['name']; ?></td>
              <td class="right"><?php foreach ($dungkhag['action'] as $action) { ?>
...
function filter() {
	url = 'index.php?route=localisation/dungkhag&token=<?php echo $token; ?>';
