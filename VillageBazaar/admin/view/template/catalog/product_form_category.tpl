          ...
          <div id="language<?php echo $language['language_id']; ?>">
            ...
            <tr>
              ...
              <tr>
                ...
                <td><input type="text" name="product_description[<?php echo $language['language_id']; ?>][name]" size="43" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['name'] : ''; ?>" /> <span style="color:blue">(Enter Product Name)</span>
			 ...
			 <tr>
              ...
              <td><input type="text" name="quantity" value="<?php echo $quantity; ?>" size="20" /></td>
            </tr>
             ...
             <!-- <tr>
              ...
              <tr>
                <td><?php echo $entry_description; ?></td>
				 ...
				 <td><textarea name="product_description[<?php echo $language['language_id']; ?>][description]" cols="80" rows="8"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['description'] : ''; ?></textarea></td>
...
$('input[name=\'related\']').autocomplete({
	...
	source: function(request, response) {
		$.ajax({
			url: 'index.php?route=catalog/productss/autocomplete&token=<?php echo $token; ?>&filter_name=' +  encodeURIComponent(request.term),
			dataType: 'json',
			success: function(json) {		
				response($.map(json, function(item) {
					return {
