        ...
        <table class="list">
          <thead>
            ...
            <!--  <td class="left"><?php if ($sort == 'p.status') { ?>
                ...
                <?php } ?></td>-->
              <td class="center"><?php if ($sort == 'p.payment_status') { ?>
                ...
                <?php } ?></td>
           <!--   <td class="right"><?php echo "Payment Status"; ?></td> -->
          ...
          <tbody>
            <tr class="filter">
              ...
              <td align="right"><input type="text" name="filter_payment_status" value="<?php echo $filter_payment_status; ?>" style="text-align: right;" /></td> <td></td>
            ...
            <tr>
             ...
             <td class="right"><?php echo $product['payment_status']; ?></td>
              <td class="right"><?php foreach ($product['action'] as $action) { if ($product['payment_status']!='Complete') { ?>
