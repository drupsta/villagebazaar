...
echo "<br>";
//$qry="SELECT DISTINCT * FROM oc_pricing_policy WHERE policy_id=".$price_duration_id;
	 ...
	 <a href="#tab-image"><?php echo $tab_image; ?></a>
      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form" >
        <div id="tab-general">
         <!-- <div id="languages" class="htabs">
          ...
          <td><select name="product-category">
              ...
              <option value="<?php echo $category['category_id']; ?>" selected="selected"><?php echo "sss".$category['name']; ?></option>
              <?php } else { ?>
        ...
        <tr>
          ...
          <td><select name="product-subcategory">
