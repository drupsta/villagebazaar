<?php 
class ControllercecadminCreateNew extends Controller {
	private $error = array();
...
//    	}
    	...
    	$this->language->load('cecadmin/CreateNew');
		
		$this->document->setTitle($this->language->get('heading_title'));
	//	$this->document->addScript('catalog/view/javascript/jquery/colorbox/jquery.colorbox-min.js');
	//	$this->document->addStyle('catalog/view/javascript/jquery/colorbox/colorbox.css');
					
		$this->load->model('cecadmin/CreateNew');
		if(!isset($_POST['logout']) && !isset($_POST['home'])){
    	if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            echo 'fghfghfh';
			$this->model_cecadmin_CreateNew->addCustomer($this->request->post);
			...
			//}
	  		...
	  		$this->redirect($this->url->link('cecadmin/success'));
                } }
      ...
      //	$this->data['breadcrumbs'][] = array(
       // 	'text'      => $this->language->get('text_home'),
        ...
        //	'separator' => false
      	...
      	//$this->data['breadcrumbs'][] = array(
       // 	'text'      => $this->language->get('text_cecadmin'),
		//	'href'      => $this->url->link('cecadmin/cecadmin', '', 'SSL'),      	
      //  	'separator' => $this->language->get('text_separator')
      //	);
		
      //	$this->data['breadcrumbs'][] = array(
       // 	'text'      => $this->language->get('text_register'),
		//	'href'      => $this->url->link('cecadmin/register', '', 'SSL'),      	
       // 	'separator' => $this->language->get('text_separator')
      	//);
		$url = '';
	...
	//	$this->data['text_adminaccount_already'] = sprintf($this->language->get('text_adminaccount_already'),$this->language->get('admin'));
		...
		$this->data['action'] = $this->url->link('cecadmin/CreateNew', 'token=' . $this->session->data['token'] .$url, 'SSL');
...
if (isset($this->error['username'])) {
    	...
    	if (isset($this->request->post['country_id'])) {
      		echo $this->data['country_id'] = $this->request->post['country_id'];
    	...
    	if (isset($this->request->post['zone_id'])) {
      		echo $this->data['zone_id'] = $this->request->post['zone_id']; 	
		...
		$this->load->model('cecadmin/CreateNew');
		$this->data['csc_details'] = $this->model_cecadmin_CreateNew->cscDetails();
	    $this->data['text_select'] = $this->language->get('text_select');
		$this->data['text_none'] = $this->language->get('text_none');
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/cecadmin/CreateNew.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/cecadmin/CreateNew.tpl';
		} else {
			$this->template = 'cecadmin/CreateNew.tpl';
		}
...
if ($this->model_cecadmin_CreateNew->getTotalUsersByEmail($this->request->post['email'])) {
	...
	/*	$this->load->model('account/customer_group');
		...
		$test1 = $this->model_cecadmin_CreateNew->getUsername($this->request->post['username']);
	//	print_r($test1);
...
//    	} 
 ...
 public function country() {
	...
	print_r($country_info)	;
		...
		$output = '<option value="0">' . 'All States' . '</option>';
		$this->load->model('localisation/zone');
		$results = $this->model_localisation_zone->getZonesByCountryId(99);
