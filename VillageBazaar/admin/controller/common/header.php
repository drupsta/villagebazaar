...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		$this->data['text_csc'] = $this->language->get('text_csc');
		...
		$this->data['text_report_product_advertised'] = $this->language->get('text_report_product_advertised');
		$this->data['text_report_product_category'] = $this->language->get('text_report_product_category');
		
		$this->data['text_report_product_expiry'] = $this->language->get('text_report_product_expiry');
		$this->data['text_active_sellers'] = $this->language->get('text_active_sellers');
		...
		$this->data['text_dungkhag'] = $this->language->get('text_dungkhag');
		...
		$this->data['text_editaccount'] = $this->language->get('text_editaccount');
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['csc'] = $this->url->link('localisation/csc', 'token=' . $this->session->data['token'], 'SSL');
			...
			//$this->data['productt'] = $this->url->link('catalog/productss', 'token=' . $this->session->data['token'], 'SSL');	
			...
			$this->data['report_product_viewed'] = $this->url->link('report/product_viewed', 'token=' . $this->session->data['token'], 'SSL');
                        $this->data['users_profile'] = $this->url->link('report/users_profile', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['report_product_advertised'] = $this->url->link('report/product_advertised', 'token=' . $this->session->data['token'], 'SSL');
                        $this->data['report_product_category'] = $this->url->link('report/product_category', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['active_sellers'] = $this->url->link('report/active_sellers', 'token=' . $this->session->data['token'], 'SSL');
                        
			$this->data['report_product_expiry'] = $this->url->link('report/product_expiry', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['store'] = HTTP_CATALOG;
                        ...
                        // $this->data['store']=$this->url->link('common/home', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['user_group'] = $this->url->link('user/user_permission', 'token=' . $this->session->data['token'], 'SSL');
                        ...
                        // Added on 27-07-2014 for creating new admin
                        
                   //    $this->data['cecadmin'] = $this->url->link('http://localhost/VillageBazaar\upload\catalog\controller\account\sellerregister', 'token=' . $this->session->data['token'], 'SSL');
                       //     $this->data['cecadmin'] = $this->url->link('http://localhost/VillageBazaar/upload/index.php?route=account/sellerregister', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['dungkhag'] = $this->url->link('localisation/dungkhag', 'token=' . $this->session->data['token'], 'SSL');
			...
			$this->data['editaccount'] = $this->url->link('user/myaccount', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->data['views'] = array();
			...
			$result1 = $this->model_user_user_group->getviews($this->user->getUserName());
			if(isset($result1)){
				//print_r($result1);
			foreach ($result1 as $result) {
					$this->data['views'][]= array(
					'view' => $result['permission'],
					'name' => $result['name'],
