	 ...
	 if(!isset($_POST['logout']) && !isset($_POST['home'])){	
		...
		$this->language->load('user/user');	
			...
			//$this->model_account_customer->editPassword($this->request->post['email'], $password);
                    ...
                    //    $this->model_account_customer->editForgottenPassword($this->request->post['email'], $password);
			$this->model_user_user->editForgottenPassword($this->request->post['email'], $password);
	 ...
	 if(!isset($_POST['logout']) && !isset($_POST['home'])){	
  	...
  	protected function getList() {
		...
		$user_total = $this->model_user_user->getTotalUsers();
		 ...
		 $this->data['manufacturers'] = $this->model_catalog_manufacturer->getUsers();
