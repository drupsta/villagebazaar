...
//Added by Astha for entering old /current password
		...
		//Added by Astha
                ...
                if (isset($this->request->post['password1'])) {
    		$this->data['password1'] = $this->request->post['password1'];
		} else {
			$this->data['password1'] = '';
		}
  	...
  	protected function validate() {
            ...
            //Added by Astha to check current password
            
            if (!$this->customer->login($_SESSION['username'], $this->request->post['password1'])) {
