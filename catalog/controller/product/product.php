...
class ControllerProductProduct extends Controller {
	...
	public function index() { 
		...
		if (isset($this->request->get['manufacturer_id'])) {
			...
			$manufacturer_info = $this->model_catalog_manufacturer->getManufacturer($this->request->get['user_id']);
		...
		if ($product_info) {
			...
			//Added by Astha
                        if (isset($this->request->get['selleraddress'])) {
				$url .= '&selleraddress=' . $this->request->get['selleraddress'];
			}
			...
			$this->data['review_status'] = $this->config->get('config_review_status');
                        // Added by Astha
                        $this->data['selleraddress'] = $this->config->get('config_selleraddress');
