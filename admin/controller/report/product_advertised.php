...
class ControllerReportProductAdvertised extends Controller { 
	public function index() {   
		...
		$this->data['createpdf'] = $this->url->link('report/product_advertised/createPDF', 'token=' . $this->session->data['token'] . $url, 'SSL');
        ...
        $results = $this->model_catalog_manufacturer->getSeller(0);
        foreach($results as $result)
        {
        	$this->data['manufacturers'][] = array(
...
//	}
	...
	public function createPDF()
	{
		...
		$pdf->Write(0, 'Recently Added Products Report', '', 0, 'C', true, 0, false, false, 0);
		...
		$tbl_footer = '</table>';
		$tbl ='<tr><td align="center">Product Name</td><td  align="center">Seller Name</td><td  align="center">State</td><td  align="center">CEC Address</td><td  align="center">Date Added</td><td  align="center">Price</td></tr>';
	
		//var_dump($product_category);
		$this->load->model('report/product');
		$results = $this->model_report_product->getRecentProducts();
		...
		foreach($results as $row){
    		...
    		$date=$row['date_added'];
    		$price = $row['price'];
    		$tbl .= '<tr><td align="center">'.$product.'</td><td align="center">'.$model.'</td><td align="center">'.$manufacturer.'</td><td align="center">'.$cec.'</td><td align="center">'.$date.'</td></tr>';
		}
