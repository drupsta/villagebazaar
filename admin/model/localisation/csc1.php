...
class ModelLocalisationcsc extends Model {
	public function addGeoZone($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "csc_detail SET name = '" . $this->db->escape($data['name']) . "', address = '" . $this->db->escape($data['address']) . "',country_id = '" . $this->db->escape($data['country_id']) . "'");
	...
	public function editGeoZone($csc_id, $data) {
		$this->db->query("UPDATE " . DB_PREFIX . "csc_detail SET name = '" . $this->db->escape($data['name']) . "', description = '" . $this->db->escape($data['description']) . "', country_id = '" . $this->db->escape($data['country_id']) . "',zone_id = '" . $this->db->escape($data['zone_id']) . "' WHERE csc_id = '" . (int)$csc_id . "'");
