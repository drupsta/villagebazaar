...
class ModelCatalogManufacturer extends Model {
	...
	public function getSeller($data = array()) {
		$sql = "SELECT distinct username, p.user_id FROM " . DB_PREFIX . "user u, " . DB_PREFIX . "product p where user_group_id = 11 and p.user_id=u.user_id ";
		...
		$sql = "SELECT distinct c.username as username, u.user_id FROM " . DB_PREFIX . "user u, " . DB_PREFIX . "customer c where u.username=c.username ";
