...
session_destroy();
//header('location:http://localhost/villagebazaar/');
header("location:http://".HTTP_SERVERIP."/villagebazaar/");

}
// Comment lines 221 to 225 for My Account. Extension from line 250 to  404 
if (isset($_POST['home'])) { 
...
<!-- Added by Astha for admin register -->
...
<?php if(!empty($hide) && in_array('catalog',$hide)){?>
  ...
  <?php } else { ?>
   <li id="catalog"><a class="top"><?php echo $text_catalog; ?></a>
	  ...
	  <?php if(!empty($hide) && in_array('subcategory',$hide)){?>

	  <div style="display:none;"><li><a href="<?php echo $subcategory; ?>"><?php echo $text_subcategory; ?></a></li></div>
...
<!-- Extension from line 250 to  404 -->
...
<li><a href="<?php echo $currency; ?>"><?php echo $text_currency; ?></a></li>
 ...
 <li><a href="<?php echo $stock_status; ?>"><?php echo $text_stock_status; ?></a></li>
	  ...
	  <div style="display:none;">
		...
		<?php if(isset($hide) && in_array('dungkhag',$hide)){?>
	  <div style="display:none;">
              <li><a href="<?php echo $dungkhag; ?>"><?php echo $text_dungkhag; ?></a></li></div>
	      <?php } else { ?>
                  <li><a href="<?php echo $dungkhag; ?>"><?php echo $text_dungkhag; ?></a></li>
	       <?php }?>
...
<li><a href="<?php echo $users_profile; ?>"><?php echo "Users Profile"; ?></a></li>
...
<form name='fabc12' action='' method='post' >
<input type="submit" name="home" value="home" class="button" style="background-color:black;color:white" />
<input type="submit" name="logout" value="logout" class="button" style="background-color:black;color:white"/></form>
