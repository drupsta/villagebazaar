    ...
    <div class="content">
      <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="list">
            ...
            <tr>
              ...
              <td class="left"><?php if ($sort == 'address') { ?>
                ...
                <?php } ?></td>
				 ...
				 <td class="left"><?php if ($sort == 'zone_id') { ?>
          ...
          <tbody>
            <?php if ($cscs) { ?>
            <?php foreach ($cscs as $geo_zone) { ?>
            <tr>
              <td style="text-align: center;"><?php if ($geo_zone['selected']) { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $geo_zone['csc_id']; ?>" checked="checked" />
                <?php } else { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $geo_zone['csc_id']; ?>" />
                <?php } ?></td>
