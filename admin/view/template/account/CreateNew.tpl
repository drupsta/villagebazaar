...
<h1><?php echo "Create New Administrator"; ?></h1> 
    ...
    <div class="content">
	 ...
	 <tr>
      ...
      <tr>
          ...
          <td><input type="text" size="2"  placeholder="+91"/>-<input type="text" size="10" maxlength="15" name="telephone" value="<?php echo $telephone; ?>" />
		...
		<tr>
          ...
          <td><input type="text" size="2" maxlength="5" placeholder="STD"/>-<input type="text" size="10" maxlength="15" name="landline" value="<?php echo $landline; ?>" />
   ...
   <h2><?php echo $text_your_address; ?></h2>
    ...
    <tr id="company-id-display">
        ...
        <tr>
          ...
          <td><input type="text" name="address_1" value="<?php echo ucwords($address_1); ?>" />
	...
	<!--	 <tr>
          <td><span class="required">&nbsp;&nbsp;</span><?php echo $entry_address_2; ?></td>
          <td><input type="text" name="address_2" value="<?php echo ucwords($address_2); ?>" /></td>
        </tr> -->
        <tr>
          <td><span class="required">*</span><?php echo $entry_address_2; ?></td>
...
<tr>
  ...
  <!--  <?php if ($text_agree) { ?>
    ...
    <div class="buttons">
      <div class="right">
        <input type="submit" value="<?php echo "continue"; ?>" class="button" />
      </div>
    </div>
    <!--<?php } ?>-->
  </form>
...
$('select[name=\'country_id\']').bind('change', function() {
	$.ajax({
//alert('test');
		url: 'index.php?cecadmin/CreateNew/country&country_id='99'&token=<?php echo $token; ?>,
		dataType: 'json',
		beforeSend: function() {
		// alert(url);
