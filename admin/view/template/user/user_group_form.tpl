	  ...
	  <tr>
            ...
            <td><div class="scrollbox">
                ...
                <div class="<?php echo $class; ?>">
                  ...
                  <?php echo $permission; ?>
                  <?php } else { ?>
		  <?php  $a=explode('/' ,$permission); ?>
                   <div class="hide" id="check"  onclick="testMe('<?php print_r($a['1']); ?>')"> <input type="checkbox" name="permission[view][]" value="<?php echo $permission; ?>" />
                  <?php echo $permission; ?></div>
                  <?php } ?>
                </div>
                <?php } ?>
              </div>
