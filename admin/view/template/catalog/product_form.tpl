...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      ...
      <!--  <a  onclick=pay(); class="button"><?php echo "Pay"; ?>     </a>-->
...
<script type="text/javascript" src="../../manoj/view/javascript/ckeditor/ckeditor.js"></script> 
...
//--></script> 
<script type="text/javascript" src="../../manoj/view/javascript/jquery/ui/jquery-ui-timepicker-addon.js"></script> 
<script type="text/javascript"><!--
$('.date').datepicker({dateFormat: 'yy-mm-dd'});
$('.datetime').datetimepicker({
	dateFormat: 'yy-mm-dd',
...
<script type="text/javascript" src="../../manoj/view/javascript/jquery/ajaxupload.js"></script>
<script type="text/javascript">
$(document).ready(function() {    
