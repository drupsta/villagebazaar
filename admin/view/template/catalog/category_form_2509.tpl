...
if(isset($_POST['displayValue']) && !isset($_POST['displayValue1']))
{
$cat_name=ucwords($_POST['displayValue']);
...
<!--<span style="color:blue"> If you want to add new category please do not select "Existing Categories" but only view them.  Select the "Existing Categories" only if you want to add new subcategory. </span>-->
          <td><?php if($_SESSION['Category_Action']=="Insert Category"){echo "Enter New Category/ Select Category: ";}?><span class="required"></span> <?php if(($_SESSION['Category_Action']=="Update Category") && !isset($_REQUEST['filter_category'])) { echo "Edit Category Name:";} else if($_SESSION['Category_Action']=="Update Category" && isset($_REQUEST['filter_category'])){echo "Selected Category :";} ?></td>
          <td>
